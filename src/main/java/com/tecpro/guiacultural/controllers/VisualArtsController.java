...
import com.tecpro.guiacultural.crud.CRUDVisualArts;
...
public class VisualArtsController {
    ...
    public String index() {
        CRUDVisualArts crud = new CRUDVisualArts();
    ...
    public String create(@RequestParam Map<String, String> params) {
        ...
        return crud.create(params.get("name"), params.get("location"), Float.parseFloat(params.get("price")), params.get("date_from"), params.get("date_until"),
                params.get("hour_from"), params.get("hour_until"), Integer.parseInt(params.get("organizer_id")), params.get("description"),params.get("artist")).toJson(true);
    }

    @RequestMapping(value = "/arts/{id}", method = RequestMethod.DELETE)
    public String delete(@PathVariable int id) {
        CRUDVisualArts crud = new CRUDVisualArts();
        return "{result:" + String.valueOf(crud.delete(id) + ", id:" + id + "}");
    }

    @RequestMapping(value = "/arts/{id}", method = RequestMethod.PUT)
    public String update(@PathVariable int id, @RequestParam Map<String, String> params) {
        ...
        return crud.update(id, params.get("name"), params.get("location"), Float.parseFloat(params.get("price")), params.get("date_from"), params.get("date_until"),
                params.get("hour_from"), params.get("hour_until"), params.get("description"), params.get("artist")).toJson(true);
    }
}
